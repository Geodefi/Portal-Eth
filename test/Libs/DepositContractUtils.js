...
describe("DepositContractUtils", async () => {
  ...
  describe("DepositContractUtils", () => {
    ...
    describe("getDepositDataRoot from pubkey, withdrawal_credentials, signature and stakeAmount", async () => {
      const pubkey = "0x91efd3ce6694bc034ad4c23773877da916ed878ff8376610633a9ae4b4d826f4086a6b9b5b197b5e148be658c66c4e9a";
      const withdrawal_credentials = "0x004f58172d06b6d54c015d688511ad5656450933aff85dac123cd09410a0825c";
      const signature = "0x8bbeff59e3016c98d7daf05ddbd0c71309fae34bf3e544d56ebff030b97bccb83c5abfaab437ec7c652bbafa19eb30661979b82e79fa351d65a50e3a854c1ef0c8537f97ceaf0f334096509cd52f716150e67e17c8085d9622f376553da51181";
      ...
      it("reverts when stakeAmount less than 1 ether", async () => {
        ...
        await expect(testContract.getDepositDataRoot(pubkey, withdrawal_credentials, signature, stakeAmount)).to.be.revertedWith(
          "DepositContract: deposit value too low"
        );
      });

      it("reverts when stakeAmount is not multiple of gwei", async () => {
        const stakeAmount = ethers.BigNumber.from(String(1e18)).add(ethers.BigNumber.from(String(1)));
        await expect(testContract.getDepositDataRoot(pubkey, withdrawal_credentials, signature, stakeAmount)).to.be.revertedWith(
      ...
      it("calculates depositDataRoot correctly with stakeAmount 32 ether", async () => {
        ...
        const response = await testContract.getDepositDataRoot(pubkey, withdrawal_credentials, signature, stakeAmount);

...
contract("ERC20RebasePermitMiddleware", function (accounts) {
  ...
  before(async function () {
    ...
    factory = await ethers.getContractFactory("$ERC20RebasePermitMiddleware");
  ...
  describe("permit", function () {
    ...
    it("rejects reused signature", async function () {
      ...
      await expectRevert(
        ...
        "ERC20RPermit: invalid signature"
      );
    });

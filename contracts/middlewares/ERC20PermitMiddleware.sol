  ...
  NoncesUpgradeable
{
   ...
   */
  function __ERC20PermitMiddleware_init(
    uint256 id_,
    address gETH_,
    string memory name_,
    ...
    __ERC20PermitMiddleware_init_unchained();
  }

  function __ERC20PermitMiddleware_init_unchained() internal onlyInitializing {}

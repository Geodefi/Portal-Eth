...
//  *
//  * @dev Isolation Mode is a geodeModule circuit braker for other contracts to stop relying on this contract.
//  * * For example, PORTAL stops deposits and validator proposals to protect users and operators.
//  *
//  * @dev todo: Withdrawal Queue
//  */

// contract IWithdrawalContract is
//   IWithdrawalContract,
//   IGeodeModule,
